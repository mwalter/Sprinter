...
export class CalculationService {
  ...
  public calculate(members: Map<string, number>, spareTime: number, sprintDuration: number, holidays: number): CalculationResult {
    ...
    const workingDays = sprintDuration * 5; // working 5 days a week
